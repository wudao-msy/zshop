...
<div id="main" class="" style="color: black; font-size: 14px; ">
    ...
    <div style="margin-right: 5%; margin-left: 5%;">
        ...
        <div align="center" style="font-size: 16px; text-decoration: underline; line-height: 2em;">
            ...
            <br />
            <p>
                <a href="http://cet.neea.edu.cn/html1/report/20053/4026-1.htm" target="_blank">关于2020年上半年CET延期举行的公告</a>
            </p>
            <br />
            <p>
                <a href="http://cet.neea.edu.cn/html1/report/20053/4025-1.htm" target="_blank">延考工作安排9问答</a>
            </p>
            <br />
            <p>
                <a href="Home/SpecialNotice" target="_self">2020年上半年考试特别提示</a>
            </p>
            <c:forEach items="${pdf3s}" var="pdf" >
                <p>
        ...
        <div id="footer">
            <div id="">
                <p>
                    ...
                    京ICP备05031027号 (Powered by :81112819)<br /><font color="red">建议浏览器：火狐浏览器、谷歌浏览器、IE9+、360浏览器（选择极速模式）</font><br />
                </p>
            </div>
        </div>
    </div>
