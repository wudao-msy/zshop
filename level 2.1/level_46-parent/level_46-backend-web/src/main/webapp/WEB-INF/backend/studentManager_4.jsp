...
<div class="panel panel-default" id="userInfo" id="homeSet">
    ...
    <div class="panel-body">
        <div class="showusersearch">
            <form class="form-inline" action="${pageContext.request.contextPath}/backend/student/findByParams_4"
...
<div class="modal fade" tabindex="-1" id="Product">
    ...
    <div class="modal-dialog modal-lg">
        ...
        <form action="${pageContext.request.contextPath}/backend/student/add_4" class="form-horizontal" method="post"  id="frmAddStudent">
...
<div class="modal fade" tabindex="-1" id="myModal">
    ...
    <div class="modal-dialog">
        <!-- 内容声明 -->
        <form action="${pageContext.request.contextPath}/backend/student/modify_4" class="form-horizontal" method="post" id="frmModifyCustomer">
        <div class="modal-content">
            <!-- 头部、主体、脚注 -->
            <div class="modal-header">
                <button class="close" data-dismiss="modal">&times;</button>
