package com.zte.level_46.constants;
...
public class Constant {
    ...
    //exam类型的状态：1---->启用 默认值
    public static final Integer EXAM_ENABLE = 1;

    //exam类型的状态：2---->禁用
    public static final Integer EXAM_DISABLE = 0;

    //student类型的状态：1---->启用 默认值
    public static final Integer STUDENT_ENABLE = 1;

    //student类型的状态：2---->禁用
    public static final Integer STUDENT_DISABLE = 0;

    public static final Integer HOME_0=0;

    public static final Integer HOME_1=1;

    public static final Integer HOME_2=2;

    public static final Integer HOME_3=3;
}
